  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">Petsamos Company</a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                      <li ><a href="itsolution.html">IT Solutions</a>
                     </li>
                     <li><a href="transport.html">Transportation</a>
                     </li>
                     <li><a href="electric.html">Electrician</a>
                     </li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                 <li><a href="full-width.html">Full Width Page</a>
                            ...
                            <li><a href="faq.html">Like our Facebook Page</a>
                            </li>
                            <li><a href="faq.html">Like our Twitter Page</a>
                            </li>
              </ul>
            </li>
          </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <p><i class="fa fa-envelope-o"></i> <abbr title="Email">E</abbr>: <a href="mailto:feedback@startbootstrap.com">pkmuthaka@muthakacop.com</a></p>
    ...
    <div class="container">
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            <p>Copyright &copy; Petsamos Company 2014</p>
          </div>
        </div>
      </footer>
